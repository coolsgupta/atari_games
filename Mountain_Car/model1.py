...
batch_size = 32
result_file = open('results_model1.txt','w+')
scores = []
# Iterate the game
    ...
    for time in range(500):
        ...
        if done:
            ...
            print("episode: {}/{}, score: {}, e: {:.2}"
                  .format(e, EPISODES, scaled_score, agent.epsilon))
            scores.append(scaled_score)
            result = ('Episode :', str(e), ' score:', str(scaled_score), ' epsilon:', str(agent.epsilon), '\n')
